<!DOCTYPE html>
<html lang="de"> <!-- Đổi sang tiếng Đức cho Bern -->
<head>
    <meta charset="utf-8">
    <meta content="IE=edge,chrome=1" http-equiv="X-UA-Compatible">
    <meta content="width=device-width, initial-scale=1" name="viewport">
    <title>Queen Nails & Lashes – Kramgasse 37, 3011 Bern</title>
    <meta name="description" content="Queen Nails & Lashes Bern - Professionelle Maniküre, Pediküre & Wimpernverlängerung. 10% Rabatt für Neukundinnen bei der ersten Buchung über unsere Website.">
    <meta name="keywords" content="Nagelstudio Bern, Queen Nails, Wimpernverlängerung, Maniküre, Pediküre, Nail Salon Bern">
    ...
    })(window,document,'script','dataLayer','GTM-MJM77PRQ');</script>
    <!-- End Google Tag Manager -->
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=AW-18105468067"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());
        gtag('config', 'AW-18105468067');
    </script>
    ...
    <style>
        *, *::before, *::after {box-sizing:border-box;}
        ...
        .map-container {
            max-width:650px; width:100%; margin:32px auto;
        ...
        .btn-call {background:#ff1493; color:#fff;}
        .btn-dir  {background:#333; color:#fff;}
        h1 {font-size:24px; font-weight:700; margin:8px 0; color: #ff1493;}
        p {font-size:16px; color:#727586; max-width:550px; margin:0;}
        .info {margin-top:16px; font-size:14px; color:#727586;}
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MJM77PRQ"
    height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    <!-- End Google Tag Manager (noscript) -->

    <!-- Nav Hostinger (giữ tạm, có thể xóa sau) -->
    <nav class="nav">
        <a href="https://hpanel.hostinger.com" rel="nofollow" target="_blank">
            <svg width="150" height="30" viewBox="0 0 150 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                <!-- SVG Hostinger giữ nguyên -->
    ...
    <div class="content">
        <!-- ===== QUEEN NAILS INFO + MAP ===== -->
        <h1>Queen Nails & Lashes</h1>
        <p>Kramgasse 37, 3011 Bern, Thụy Sĩ</p>

        <!-- NÚT GỌI (GTM sẽ track) -->
        <a href="tel:+41798050068" class="btn btn-call">
            📞 Gọi ngay: +41 79 805 00 68
        </a>

        <!-- NÚT CHỈ ĐƯỜNG (GTM sẽ track) -->
        <a href="https://maps.google.com/maps?q=Queen+Nails+and+Lashes,Kramgasse+37,3011+Bern,Switzerland" 
           target="_blank" class="btn btn-dir">
            🗺️ Chỉ đường đến tiệm
        </a>

        <!-- GOOGLE MAP EMBED -->
        <div class="map-container">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2723.7069105321416!2d7.447765676550413!3d46.94779923323815!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x478e39175794629d%3A0xc59c19b668336eb2!2sQueen%20Nails%20and%20Lashes!5e0!3m2!1svi!2s!4v1762156212130" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>

        <p class="info">Mở cửa: Thứ 2 – Thứ 7 | 09:00 – 19:00</p>
    </div>

    <!-- Consent Mode v2 (Thụy Sĩ) - bắt buộc -->
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
